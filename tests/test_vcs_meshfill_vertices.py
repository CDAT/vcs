...
class TestVCSMeshfillVertices(basevcstest.VCSBaseTest):
    def testVCSMeshfillVertices(self):
        ...
        self.x.plot(numpy.array(data_values,),mesh,m,bg=self.bg)
        self.checkImage("test_vcs_meshfill_vertices_issue.png")
