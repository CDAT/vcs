...
class TestVCSVerifyBoxfill(basevcstest.VCSBaseTest):
    def testVCSVerifyBoxfillBasics(self):
        ...
        try:
          ...
          pass
        self.check_values_setting(b, ["xticlabels1","xticlabels2","xmtics1","xmtics2", "yticlabels1","yticlabels2","ymtics1","ymtics2",],["*","",None,"lon20",{23.:"Hi",}],["bla",10,10.,[],()])
        self.check_values_setting(b,["datawc_x1","datawc_x2","datawc_y1","datawc_y2"],[56,56.7,],["bla",[4,5,6],None,{}])
        self.check_values_setting(b,"datawc_timeunits",["months since 1800","years since 234",],[1,"bla",2.,{},[],(),None])
        self.check_values_setting(b,"datawc_calendar",[cdtime.GregorianCalendar,cdtime.JulianCalendar,cdtime.MixedCalendar,cdtime.NoLeapCalendar,cdtime.StandardCalendar],[4,"bla",{},[],(),None])
        self.check_values_setting(b,['xaxisconvert','yaxisconvert'],['linear', 'log10', 'ln', 'exp', 'area_wt'],['log','bla',[],(),{},8,0,1,None])
        self.check_values_setting(b,"boxfill_type",['linear', 'log10','custom',0,1,2],['bla',45,(),[],{},None])
        self.check_values_setting(b,["level_1","level_2"],[2,2.,1.e20,],['1',[1,2,3,4],[1,],{3:"3"},None])
        self.check_values_setting(b,"levels",[[1,2,3,4],[1,2.,45.],[[1,2],[4,5],[6,7]]],[1,[1,2,'4'],[],{},{1:'1'},None,[[1,2],[1,2,3]]])
        self.check_values_setting(b,["color_1","color_2","missing"],[2,"red",[100,5.,4],[23,4,5,50],242],["foo",-5,345,[56,],[1,2,3,4,5],[],{},None])
        self.check_values_setting(b,"fillareacolors",[[1,2,3],[1,"red","blue"],None],['1',{},[-3,-5,-6],[1,2,"foo"]])
        fa = self.x.createfillarea()
        self.check_values_setting(b,"fillareaindices",[[1,2,3],[1,fa],None],['1',{},[-3,-5,-6],[1,2,"foo"],[0,1,2],[1,23]])
        self.check_values_setting(b,"fillareastyle",[0,1,2,3,fa,"solid","hatch","pattern","hallow"],[-1,4,"bla",[],{},b,None])
        self.check_values_setting(b,"legend",[None,{},{1:"23"},[1,2,3],6],[["bla",1,2],])
        self.check_values_setting(b,["ext_1","ext_2"],["y","n",0,1,True,False,"yes","no","Y","N","YES","NO",None," y ","yes ", ],[2,'maybe','foo','nope','yesish', "no and yes"])
