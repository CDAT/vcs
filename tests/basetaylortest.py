...
class VCSTaylorBaseTest(basevcstest.VCSBaseTest):
    def setUp(self):
        ...
        self.data = MV2.array(zip(std, corr))
        ...
        self.symbols = ["square","dot","circle","triangle_right","triangle_left","triangle_up","triangle_down"]
        self.colors = ["red","black","black","black","black","black","blue"]
        self.id_sizes = [20., 15., 15., 15., 15., 15., 15.,]
        self.id_colors = ["orange","grey","grey","grey","grey","grey","cyan"]
