...
class TestVCSEndConfigure(basevcstest.VCSBaseTest):
    def testEndConfigure(self):
        ...
        self.assertIsNone(self.x.configurator, "x.close() did not end configuration")
        ...
        self.assertIsNone(self.x.configurator, "x.onClosing did not end configuration")

        self.assertTrue(fake.detached, "x.onClosing() did not detach configurator")
