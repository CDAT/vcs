...
class TestVCSSaveTd(unittest.TestCase):
    def test_vcs_save_td_json(self):
        ...
        good_json = os.path.join(os.path.dirname(__file__),"share","vcs_test_save_td_to_json.json")
        self.assertTrue(filecmp.cmp("vcs_test_save_td_to_json.json",good_json))
        td.script("vcs_test_save_td_to_py.py","w")
        good_py = os.path.join(os.path.dirname(__file__),"share","vcs_test_save_td_to_py.py")
