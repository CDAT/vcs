...
conda create -n py3 -c uvcdat/label/nightly -c nadeau1  -c conda-forge -c uvcdat cdms2 nose flake8 "python>3" cdat_info udunits2 dv3d mesalib nose image-compare flake8 "matplotlib<2.1" numpy=1.13 image-compare
conda create -n py2 -c uvcdat/label/nightly -c conda-forge -c uvcdat cdms2 cdat_info udunits2 nose flake8 dv3d mesalib nose image-compare flake8 "matplotlib<2.1" numpy=1.13 image-compare
