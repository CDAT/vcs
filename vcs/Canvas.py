        ...
        :Example:
            ...
            .. doctest:: canvas_streamline
                ...
                *******************End Streamline Names List**********************
                ...
                >>> a.streamline(slab1, slab2) # plot streamline using slab and default streamline
                <vcs.displayplot.Dp ...>
                >>> a.clear() # Clear VCS canvas
                >>> template=a.gettemplate('hovmuller')
                >>> a.streamline(slab1, slab2, template) # Plot array using default streamline and specified template
                <vcs.displayplot.Dp ...>
