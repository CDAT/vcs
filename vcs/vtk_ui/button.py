...
class ButtonState(object):
    ...
    def __init__(
            self, label='', image=None, bgcolor=None, fgcolor=None, opacity=None):
        self.label = label
        self.image = image
...
class Button(Widget):
    ...
    def add_state(
            self, label=None, image=None, bgcolor=None, fgcolor=None, opacity=None):
        self.states.append(
            ButtonState(
                label=label,
                image=image,
    ...
    def copy(self, interactor, button_type=None, button_args=None,
             button_kwargs=None, skip_args=None):
        ...
        b = Button(interactor, action=self.action, corner_radius=self.radius, width=self.width,
                   height=self.height, left=self.left, top=self.top, image=self.image,
                   label=self.label, bgcolor=self.bgcolor, fgcolor=self.fgcolor,
                   opacity=self.opacity, size=self.size, states=self.states,
...
class ToggleButton(Button):
    ...
    def __init__(self, interactor, label, on=None, off=None, corner_radius=5, width=None,
                 height=None, left=0, top=0, image=None, bgcolor=(.5, .5, .5),
                 fgcolor=(1, 1, 1), font="Arial",
                 opacity=1, size=14, states=None, halign=LEFT_ALIGN,
                 valign=CENTER_ALIGN, on_prefix="Enable", off_prefix="Disable"):

        super(ToggleButton, self).__init__(interactor, action=self.toggle, corner_radius=corner_radius,
                                           width=width,
                                           ...
                                           [ButtonState(label="%s %s" %
                                                        (on_prefix, label)), ButtonState(label="%s %s" %
                                                                                         (off_prefix, label))],
    ...
    def copy(self, interactor):
        b = ToggleButton(interactor, self.label, on=self.on, off=self.off,
                         corner_radius=self.radius, width=self.width,
                         height=self.height, left=self.left, top=self.top,
                         image=self.image, bgcolor=self.bgcolor, fgcolor=self.fgcolor,
                         opacity=self.opacity, size=self.size,
                         states=self.states, halign=self.halign, valign=self.valign)
...
class SliderButton(ToggleButton):
    ...
    def copy(self, interactor):
        ...
        b = SliderButton(interactor, value, min_val, max_val, self.label, update=self.slider.update_callback,
                         end=self.slider.end_callback,
                         corner_radius=self.radius, width=self.width, height=self.height, left=self.left,
                         top=self.top, image=self.image,
                         bgcolor=self.bgcolor, fgcolor=self.fgcolor, opacity=self.opacity, size=self.size,
                         states=self.states, halign=self.halign, valign=self.valign,
