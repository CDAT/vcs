...
class BoxEditor(behaviors.DraggableMixin, priority.PriorityEditor):
    ...
    Places a handle on each corner of the box
    allows box to be dragged (moves handles with drag),
    will manipulate priority using up/down arrows and delete key to set to 0.
    """
